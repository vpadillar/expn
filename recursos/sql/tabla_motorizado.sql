...
select tabla_motorizado(3,'','',0,10)
select empresa_id from usuario_empleado where usuario_ptr_id = 3 limit 1
select * from usuario_empleado
select * from motorizado_moto
select * from motorizado_motorizado
update motorizado_moto set estado=true
