...
(function (global, undefined) {
	...
	Alertify = function () {
		...
		var _alertify = {},
		    ...
		    queue     = [],
		    $, elCallee, elCover, elDialog, elLog,temporal_variable;
		...
		_alertify = {
			...
			close : function (elem, wait) {
				...
				this.bind(elem, "click", function () {
					console.log("cerrando la pelicula");
					temporal_variable = elem;
					//console.log(temporal_variable.find('input[type:"radio"]'id_ped));

					//elLog.removeChild(temporal_variable);
				});
				//alert(timer);
				/*setTimeout(function () {
		...
		return {
			...
			cerrar  : function(){elLog.removeChild(temporal_variable);},
